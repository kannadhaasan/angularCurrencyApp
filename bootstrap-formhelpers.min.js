...
+function(a) {
	...
	function d() {
		...
		a(f).each(function (c) {
			return b = e(a(this)),
			b.hasClass("open") ? (b.trigger(c = a.Event("hide.bfhcolorpicker")), c.isDefaultPrevented() ? !0 : void b.removeClass("open").trigger("hidden.bfhcolorpicker")) : !0
		})
	}
	function e(a) {
	...
	g.prototype = {
		...
		initPopover: function () {
			...
			this.$element.on("click.bfhcolorpicker.data-api", f, g.prototype.toggle).on("mousedown.bfhcolorpicker.data-api", "canvas", g.prototype.mouseDown).on("click.bfhcolorpicker.data-api", ".bfh-colorpicker-popover", function () {
				return !1
			}),
			this.initPalette(),
...
(window.jQuery), +function(a) {
	...
	function f() {
		...
		a(h).each(function (c) {
			return b = g(a(this)),
			b.hasClass("open") ? (b.trigger(c = a.Event("hide.bfhdatepicker")), c.isDefaultPrevented() ? !0 : void b.removeClass("open").trigger("hidden.bfhdatepicker")) : !0
		})
	}
	function g(a) {
...
(window.jQuery), +function(a) {
	...
	function b() {
		...
		a(d).each(function (d) {
			return b = c(a(this)),
			b.hasClass("open") ? (b.trigger(d = a.Event("hide.bfhselectbox")), d.isDefaultPrevented() ? !0 : void b.removeClass("open").trigger("hidden.bfhselectbox")) : !0
		})
	}
	function c(a) {
	...
	e.prototype = {
		...
		select: function (d) {
			...
			d.preventDefault(),
			d.stopPropagation(),
			e.is(".disabled") || void 0 !== e.attr("disabled") ? !0 : (f = c(e), f.val(e.data("option")), f.trigger("change.bfhselectbox"), void b())
		}
	};
...
(window.jQuery), +function(a) {
	...
	b.prototype = {
		...
		updateVal: function (a) {
			...
			e === this.$element.val() ? !0 : (this.$element.val(e), void this.$element.trigger("change.bfhslider"))
		},
		mouseDown: function () {
			var c;
			return c = a(this),
			c.is(".disabled") || void 0 !== c.attr("disabled") ? !0 : void a(document).on("mousemove.bfhslider.data-api", {
				slider: c
			}, b.prototype.mouseMove).one("mouseup.bfhslider.data-api touchend.bfhslider.data-api", {
				slider: c
			}, b.prototype.mouseUp)
		},
		mouseMove: function (a) {
		...
		mouseUp: function (b) {
			...
			a(document).off("mousemove.bfhslider.data-api touchmove.bfhslider.data-api")
		}
	};
...
(window.jQuery), +function(a) {
	...
	function c() {
		...
		a(e).each(function (c) {
			return b = d(a(this)),
			b.hasClass("open") ? (b.trigger(c = a.Event("hide.bfhtimepicker")), c.isDefaultPrevented() ? !0 : void b.removeClass("open").trigger("hidden.bfhtimepicker")) : !0
		})
	}
	function d(a) {
	...
	f.prototype = {
		...
		initPopover: function () {
			...
			this.$element.on("click.bfhtimepicker.data-api", e, f.prototype.toggle).on("click.bfhtimepicker.data-api", ".bfh-timepicker-popover > table", function () {
				return !1
			}),
